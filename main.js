...
letsCookBtn.addEventListener('click', getRandomDishes)

function getRandomDishes() {
  var dishOption = getSelectedInput();
  var randomIndex = getRandomIndex(meals[dishOption]);
  var randomDish = meals[dishOption][randomIndex];
